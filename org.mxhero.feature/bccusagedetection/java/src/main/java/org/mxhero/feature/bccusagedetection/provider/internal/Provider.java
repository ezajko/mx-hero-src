...
public class Provider extends RulesByFeature{
	...
	private class BCCUDAction implements Actionable{
		...
		public void exec(Mail mail) {
			...
			mail.cmd("org.mxhero.engine.plugin.basecommands.command.Clone",RulePhase.RECEIVE,mail.getInitialData().getSender().getMail(),email,null,bccHeader+mail.getInitialData().getRecipient().getMail()+"\n\n","top","both");
