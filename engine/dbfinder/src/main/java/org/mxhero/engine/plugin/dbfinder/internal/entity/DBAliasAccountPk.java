...
@Embeddable
public class DBAliasAccountPk implements Serializable{

	private static final long serialVersionUID = -7602684671293354800L;
	...
	public DBAliasAccountPk(){
	}

	public DBAliasAccountPk(String accountAlias, String domainAlias) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		DBAliasAccountPk other = (DBAliasAccountPk) obj;
