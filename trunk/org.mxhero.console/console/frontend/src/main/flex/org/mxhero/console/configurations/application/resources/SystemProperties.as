package org.mxhero.console.configurations.application.resources
{
	...
	{
		public static const NAME:String="configurations_system";
		...
		public static const FORM_CHECK_AUTH:String="form.check.auth";
		
		public static const FORM_USER_LABEL:String="form.user.label";
		
		public static const FORM_PASSWORD_LABEL:String="form.password.label";
		
		public static const FORM_CHECK_SSL:String="form.check.ssl";
		
		public static const FORM_UPDATE_MAIL_LABEL:String="form.update.mail.label";
		...
		public static const FORM_TEST_MAIL_LABEL:String="form.test.mail.label";
