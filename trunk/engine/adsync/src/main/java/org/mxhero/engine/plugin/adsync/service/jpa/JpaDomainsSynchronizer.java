...
public class JpaDomainsSynchronizer implements DomainsSynchronizer{
	...
	public static final String ZIMBRA_FILTER="(&(|(objectclass=zimbraAccount)(objectclass=zimbraDistributionList))(mail=*)(uid=*))";
	public static final String EXCHANGE_FILTER="(&(objectclass=user)(mail=*)(uid=*))";
