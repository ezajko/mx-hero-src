...
public class RecipientRuleTaskTest {

	@Test
	public void testTask() throws MessagingException{
		...
		RecipientRuleTask task = new RecipientRuleTask(kbase.newStatefulKnowledgeSession(), mail, domainFinder, userFinder);
		...
		Assert.assertTrue(OutputQueue.getInstance().contains(mail));
	}
