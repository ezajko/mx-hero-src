		...
		<tbody>
						...
						<tbody>
							<tr>
								...
								<td align="center"><p
										...
										<strong
											style="display: block; clear: both; width: 100%; font-size: 28px; line-height: 28px; font-weight: bold;"><spring:message code="error.general.title"/></strong>
									</p></td>
			...
			<tr>
				<td align="left" valign="top"
					style="background-image: #f2f2f2 url('<c:url value='/static/images/left.gif'/>') top left repeat-y;"
				...
				<td align="center" bgcolor="#f2f2f2" style="background: #f2f2f2;"><span
					style="font-size: 16px; font-family: Arial, Helvetica, sans-serif; color: #000;">&nbsp;<br /><spring:message code="error.nonauth.message"/>
				</span></td>
				<td align="right" valign="top"
					style="background-image: #f2f2f2 url('<c:url value='/static/images/right.gif'/>') top right repeat-y;"
