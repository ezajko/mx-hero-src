...
public class GmailForward {

	private static Logger log = LoggerFactory.getLogger(GmailForward.class);
	...
	private MimeMail readGmail() throws MessagingException{
		return new MimeMail("sender@example.com", 
				"recipient@example.com", 
				this.getClass().getClassLoader().getResourceAsStream("gmailforward.eml"), 
				"service"); 
	}
	...
	public void insertTxt() throws MessagingException, IOException{
		...
		append.exec(mail,new AppendCurrentParameters("PLAIN TEXT HERE", "<b>HTML TEXT HERE</b>"));
