		...
		<tbody>
						...
						<tbody>
							<tr>
								...
								<td align="center"><p
										...
										<strong
											style="display: block; clear: both; width: 100%; font-size: 28px; line-height: 28px; font-weight: bold;"><%=bundle.getString("not.allowed.title") %></strong>
									</p></td>
			...
			<tr>
				...
				<td align="center" bgcolor="#f2f2f2" style="background: #f2f2f2;"><span
					style="font-size: 16px; font-family: Arial, Helvetica, sans-serif; color: #000;">&nbsp;<br /><%=bundle.getString("not.allowed.message") %>
				</span></td>
